            ...
            <div class="d-inline-flex justify-content-around py-5">
                <div class="d-flex col-4 py-3 justify-content-center rounded bg-light" style="cursor: default;">
                    <div class="modal fade" id="expand_photo_arthur" tabindex="-1" style="display: none;">
                        <div class="modal-body modal-dialog modal-dialog-centered rounded" style="background-image: url(assets/imagens/arthur.jpeg); background-position: center 15%; height: 80vh;"></div>
                    </div>
                    <div class="d-flex flex-column justify-content-center">
                        <!-- Imagem do integrante -->
                        <div class="d-flex justify-content-center">
                            <a class="rounded-circle equipe_album_photo modal-dialog-centered" style="background-image: url(assets/imagens/arthur.jpeg); background-position: center 15%;" data-bs-toggle="modal" data-bs-target="#expand_photo_arthur" role="button"></a>
                        </div>
