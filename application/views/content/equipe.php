<article class="p-0 bg-white" id="equipe">
        ...
        <div class="d-flex flex-column justify-content-around w-100">
            <div class="d-inline-flex justify-content-around py-5">
                <?php foreach($equipe['integrantes'] as $integrante): ?>
                    <div class="d-flex col-3 py-3 justify-content-center rounded bg-light" style="cursor: default;">
            ...
            <div>
                <div>
                    <div class="text-center dropend">
                        <a class="btn dropdown-toggle fs-4" href="<?=base_url('app/doc/'.$team.'')?>"> Ver documentação </a>
                    </div>
                </div>
            </div>
        </div>
